...
function AutoScrapper:GetScrappableItems()
	...
	kprint(
		"Settings:",
		"autoFillScrapper",
		profile.autoFillScrapper,
		"protectHigherIlvl",
		profile.protectHigherIlvl,
		"maxQuality",
		profile.maxQuality
	)
...
function AutoScrapper:FillNextBatch()
	...
	-- Guard against combat lockdown or scrapper not visible
	...
	-- Defensive: clear cursor if something was left hanging
